...
/**
 * This class implements the Caesar Cipher, a simple substitution cipher used for encryption and
 * decryption of text.
 */
public class CaesarCipher {
   ...
   * @param shift The number of positions to shift the characters (positive for encryption, negative
   *     for decryption).
